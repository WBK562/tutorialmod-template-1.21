package net.wbk.tutorialmod.block.datagen;
...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        List<ItemConvertible> PINK_GARNET_SMELTIBLES = List.of(ModItems.RAW_PINK_GARNET, ModBlocks.PINK_GARNET_ORE,
                ModBlocks.PINK_GARNET_DEEPSLATE_ORE);

        offerSmelting(recipeExporter,PINK_GARNET_SMELTIBLES, RecipeCategory.MISC, ModItems.PINK_GARNET,0.25f,200,"pink_garnet");
        offerBlasting(recipeExporter,PINK_GARNET_SMELTIBLES, RecipeCategory.MISC, ModItems.PINK_GARNET,0.25f,100,"pink_garnet");
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC,ModItems.RAW_PINK_GARNET, 9)
                ...
                .criterion(hasItem(ModBlocks.PINK_GARNET_BLOCK),conditionsFromItem(ModBlocks.RAW_PINK_GARNET_BLOCK))
                .offerTo(recipeExporter);
